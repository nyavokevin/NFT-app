...
export const EndDate = () => {
    return (
      <View style={{
        ...
        <Text style={{ fontFamily: FONTS.regular, fontSize: SIZES.small, color: COLORS.primary }} >Eding in</Text>
        <Text style={{ fontFamily: FONTS.semiBold, fontSize: SIZES.medium, color: COLORS.primary }} >12h 30min</Text> 
      </View>
    )
}
